...
Runtime materialization is the process of making a project locally runnable
without treating `.runtime/` as authored source.
...
Alteran manages one effective Deno version per runtime. The managed Deno lives
under the platform-specific branch:
...
- `.runtime/alteran/`, `.runtime/tools/`, `.runtime/libs/`: generated local
  material
