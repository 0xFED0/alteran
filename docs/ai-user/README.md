...
- `skills/bootstrap-and-entry.md`
- `skills/apps-tools-and-libs.md`
- `skills/managed-execution-and-logging.md`
...
- Alteran repository-maintainer workflows
- repository ADR decisions in full detail
- publication internals for the Alteran product itself
